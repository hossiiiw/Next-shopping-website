    ...
    <div className="p-6 flex items-center justify-center">
      <div className="absolute top-18">
        ...
        <input
          ...
          type="number"
          className="bg-white w-24 p-2 rounded mx-2 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
          placeholder="price"
        />
        <select
        ...
        <button
          ...
          className="bg-sky-400 p-2 rounded font-bold text-white"
        >
          Search
        </button>
      </div>
